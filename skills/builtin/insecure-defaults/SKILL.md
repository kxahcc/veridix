...
description: Detects fail-open insecure defaults (hardcoded secrets, weak auth, permissive
  security) that allow apps to run insecurely in production. Use when auditing security,
  reviewing config management, or analyzing environment variable handling.
...
license: ''
version: 1.0.0
trigger: web_discovery,host,code_audit
required_tools:
- shell.probe
- web.replay
